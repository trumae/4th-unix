...
offset info-4th
  ...
  TAG info-4th |,""|
    c| ,"" 4TH| 10 c,
    c| Compiles to: ," (<address of null string constant>)| 10 c,
    c" Compile a null string in the String Segment and leave the offset" 10 c,
    c" as the address of a string constant (see: @C)." 10 c,
    0 c,
  TAG info-4th ",|"
    c" ,| 4TH" 10 c,
    c| Compiles to: ," (<address of string constant>)| 10 c,
